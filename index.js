const contentLetterSrart_actived = "Chúc mừng sinh nhật chị Xuân Mêi"; //Lời mở đầu cho bức thư
const mainContentLetter =
  "Chúc chị tuổi mới sẽ luôn giữ được nụ cười trên môi, chúc chị luôn mạnh khỏe, may mắn, thành công trong công việc và hạnh phúc bên những người mà chị yêu thương, Happy birthday to you!!!."; //Nội dung của bức thư
